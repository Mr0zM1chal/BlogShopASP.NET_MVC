...
namespace BlogShopMVC.DAL
{
    public class ShopInitializer : MigrateDatabaseToLatestVersion<ShopContext, Configuration>
    {
        public static void SeedShopData(ShopContext context)
        {
            ...
            {
                new Category (){ CategoryDescription = "Kubki, smycze, wlepy", CategoryId = 2, CategoryName = "Akcesoria", IconFileName = "xyz2", },
                new Category (){ CategoryDescription = "Koszulki, koszulki polo", CategoryId = 3, CategoryName = "Koszulki", IconFileName = "xyz3", },
                new Category (){ CategoryDescription = "Płyty winyle + blueray", CategoryId = 4, CategoryName = "Płyty", IconFileName = "xyz4", },
                new Category (){ CategoryDescription = "Ksiżąki, gazety", CategoryId = 5, CategoryName = "Książki", IconFileName = "xyz5", }
            };
            ...
            var products = new List<Product>
            {
                ...
                new Product(){ CategoryId = 5, ProductId = 10, ProductMake = "Bloger", ProductModel = "Poradnik", ProductPrice = 2.99},
                new Product(){ CategoryId = 5, ProductId = 11, ProductMake = "Bloger", ProductModel = "Przygody blogera", ProductPrice = 22.99},
                new Product(){ CategoryId = 5, ProductId = 12, ProductMake = "Bloger", ProductModel = "Album", ProductPrice = 52.99},
            };
